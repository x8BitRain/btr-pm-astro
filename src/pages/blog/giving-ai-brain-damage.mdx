...
But I'm going to use the classic, [Vinesauce ROM Corruptor](https://corrupt.wiki/other-corruptors/classic-corruptors/vinesauce-rom-corruptor) that is a GUI wrapper around this concept with some extra parameters like how many bytes to skip before modifying a value.
