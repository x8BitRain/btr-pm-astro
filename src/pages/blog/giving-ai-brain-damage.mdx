...
Add 2 bytes to every 120 bytes.
...
Now what happens if I add 2 bytes to every 200 bytes, aka 3mb of corrupted data out of 640mb.
...
Let's try adding 2 bytes to every 280 bytes:
