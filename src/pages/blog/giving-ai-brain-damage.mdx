...
Here is a visual demonstration of what I mean by a scanning effect. If you increase he "Corrupt every x bytes" value you're lowering the amount of total bytes corrupted while also changing the position of the corrupted bytes each time.
