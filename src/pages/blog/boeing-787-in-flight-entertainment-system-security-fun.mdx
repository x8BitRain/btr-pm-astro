...
<Picture
    src={`/src/data/images/blog/${frontmatter.slug}/787.png`}
    sizes={"400, 800, 1200"}
    alt="Boeing 787"
...
<Picture
    src={`/src/data/images/blog/${frontmatter.slug}/1.jpg`}
    sizes={"400, 800, 1200"}
    alt="Flash Player not working on Ubuntu"
    format={["avif", "jpeg", "png", "webp"]}
    placeholder="blurred"
/>
...
<Picture
    src={`/src/data/images/blog/${frontmatter.slug}/2.jpg`}
    sizes={"400, 800, 1200"}
    alt="Inspecting connections in Chrome dev tools"
    format={["avif", "jpeg", "png", "webp"]}
    placeholder="blurred"
/>
...
<Picture
    src={`/src/data/images/blog/${frontmatter.slug}/3.jpg`}
    sizes={"400, 800, 1200"}
    alt="3D map system found in many IFEs"
    format={["avif", "jpeg", "png", "webp"]}
    placeholder="blurred"
/>
...
<Picture
    src={`/src/data/images/blog/${frontmatter.slug}/4.jpg`}
    sizes={"400, 800, 1200"}
    alt="PA Announcement screen in browser"
    format={["avif", "jpeg", "png", "webp"]}
    placeholder="blurred"
/>
